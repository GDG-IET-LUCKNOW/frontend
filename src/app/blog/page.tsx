        ...
        if (data && data.length > 0) {
          const mappedBlogs = data.map((b: any) => ({
            ...
            excerpt: b.content ? b.content
              ...
              .replace(/&quot;/g, '"')
              .replace(/&#39;/g, "'")
              .substring(0, 120) + "..." : "A deep dive into how changing the way we build modern web applications and optimizing bundle sizes.",
      ...
      <div className="max-w-6xl mx-auto px-4 z-10 w-full relative">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {isLoading ? (
            ...
            posts.map((post, idx) => (
              <Link key={post.id} href={`/blog/${post.id}`} prefetch={false} className="block w-full md:w-[calc(50%_-_1rem)] shrink-0">
                <motion.div
