      ...
      <div className="max-w-6xl mx-auto px-4 w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex items-center space-x-4 pt-4">
            <a href="https://chat.whatsapp.com/DNRnsEzErLAGTgKQsyKrCb" target="_blank" rel="noreferrer" className="group relative px-6 py-3 rounded-full bg-primary text-primary-foreground font-medium overflow-hidden inline-block cursor-pointer">
