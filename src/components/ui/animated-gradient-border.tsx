...
const BorderRotate: React.FC<BorderRotateProps> = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* The actual rotating gradient border psuedo-element via separate div to allow hollow masking */}
      <div 
        className={`absolute inset-0 pointer-events-none rounded-[inherit] ${getAnimationClass()}`}
        style={{
